        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              ...
              <li class="nav-item"> <a class="nav-link" href="{{ route('settings.index') }}">New Admin</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('Renter.Details') }}">Renter Details</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('Landlord.Details') }}">Landlord Details</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
