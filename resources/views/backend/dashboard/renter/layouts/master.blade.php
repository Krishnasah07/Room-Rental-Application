...
<html lang="en">
  <head>
    ...
    <title>Renter ~ @yield('title') </title>
    <!-- plugins:css -->
  ...
  <body>
    <div class="container-scroller">
      ...
      @include('backend.dashboard.renter.common.sidebar')
      <!-- partial -->
      <div class="container-fluid page-body-wrapper">
        <!-- partial:partials/_navbar.html -->
        @include('backend.dashboard.renter.common.nav')
        <!-- partial -->
        ...
        @include('backend.dashboard.renter.common.footer')
          <!-- partial -->
        </div>
        <!-- main-panel ends -->
      </div>
