...
class RenterSettingsController extends Controller
{
    public function index(){
        ...
        $Renter = User::find($id);
        // dd($Renter);
        return view('backend.dashboard.renter.Settings.RenterSettings',compact('Renter'));
    }
...
// return view('backend.dashboard.renter.Settings.RenterSettings');
